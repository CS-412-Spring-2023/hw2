...
\begin{questions}
  ...
  \begin{parts}
    \part[5] Describe an algorithm using network flows which given the above table of possibilities as an input, computes whether a it is possible to generate a feasible schedule or not.
    \part[5] What is the time complexity of your algorithm in terms of $n$? Apply your algorithm to the above table (Table \ref{key}) to determine if it generates a feasible schedule or not.
  \end{parts}
  \begin{solution}
